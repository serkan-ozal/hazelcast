...
public interface EventResponseTemplate {
    ...
    void CacheInvalidation(@Nullable String name, @Nullable Data key, @Nullable String sourceUuid);

    @EventResponse(EventMessageConst.EVENT_CACHEBATCHINVALIDATION)
    void CacheBatchInvalidation(@Nullable String name, List<Data> keys, @Nullable List<String> sourceUuids);
