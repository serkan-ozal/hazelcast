...
public class GroupProperties {
    ...
    public static final String PROP_SOCKET_SERVER_RECEIVE_BUFFER_SIZE = "hazelcast.socket.server.receive.buffer.size";
    public static final String PROP_SOCKET_SERVER_SEND_BUFFER_SIZE = "hazelcast.socket.server.send.buffer.size";
    ...
    // number of kilobytes
    public final GroupProperty SOCKET_SERVER_RECEIVE_BUFFER_SIZE;

    // number of kilobytes
    public final GroupProperty SOCKET_SERVER_SEND_BUFFER_SIZE;
    ...
    public GroupProperties(Config config) {
        ...
        SOCKET_SERVER_RECEIVE_BUFFER_SIZE = new GroupProperty(config, PROP_SOCKET_SERVER_RECEIVE_BUFFER_SIZE, "-1");
        SOCKET_SERVER_SEND_BUFFER_SIZE = new GroupProperty(config, PROP_SOCKET_SERVER_SEND_BUFFER_SIZE, "-1");
