...
final class PerformanceLogFile {
    ...
    private final BodyRendered bodyRendered;
    ...
    PerformanceLogFile(PerformanceMonitor performanceMonitor) {
        this.bodyRendered = new BodyRendered(performanceMonitor.humanFriendlyFormat);
    ...
    private final class BodyRendered {
        ...
        public BodyRendered(boolean humanFriendlyFormat) {
