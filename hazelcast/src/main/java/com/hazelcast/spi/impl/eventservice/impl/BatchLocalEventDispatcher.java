...
public final class BatchLocalEventDispatcher implements StripedRunnable, TimeoutRunnable {
    ...
    BatchLocalEventDispatcher(EventServiceImpl eventService, String serviceName, Object event,
                              Collection listeners, int orderKey, long timeoutMs) {
