...
import com.hazelcast.internal.memory.strategy.UnsafeDependentMemoryAccessStrategyTest;
...
public abstract class BaseMemoryAccessStrategyTest extends UnsafeDependentMemoryAccessStrategyTest {

    protected final Unsafe UNSAFE = UnsafeUtil.UNSAFE;

    private MemoryAccessStrategy memoryAccessStrategy;

    abstract protected MemoryAccessStrategy createMemoryAccessStrategy();
    ...
    private void do_test_copyMemory(boolean aligned) {
        ...
        try {
            ...
            for (int i = 0; i < COPY_LENGTH; i++) {
                memoryAccessStrategy.putByte(accessSourceAddress + i, (byte) (i * i));
            }

            memoryAccessStrategy.copyMemory(accessSourceAddress, accessDestinationAddress, COPY_LENGTH);

            for (int i = 0; i < COPY_LENGTH; i++) {
                assertEquals((byte) (i * i), memoryAccessStrategy.getByte(accessDestinationAddress + i));
            }
    ...
    private void do_test_setMemory(boolean aligned) {
        ...
        try {
            ...
            memoryAccessStrategy.setMemory(accessAddress, SET_LENGTH, (byte) 0x01);

            for (int i = 0; i < SET_LENGTH; i++) {
                assertEquals((byte) 0x01, memoryAccessStrategy.getByte(accessAddress + i));
            }
        } finally {
            if (address != 0) {
                freeMemory(address);
    ...
    public void test_putGetBoolean() {
        ...
        try {
            ...
            memoryAccessStrategy.putBoolean(address, true);
            assertEquals(true, memoryAccessStrategy.getBoolean(address));
    ...
    public void test_putGetByte() {
        ...
        try {
            ...
            memoryAccessStrategy.putByte(address, (byte) 1);
            assertEquals(1, memoryAccessStrategy.getByte(address));
    ...
    private void do_test_putGetChar(boolean aligned) {
        ...
        try {
            ...
            memoryAccessStrategy.putChar(accessAddress, 'A');
            assertEquals('A', memoryAccessStrategy.getChar(accessAddress));
    ...
    private void do_test_putGetShort(boolean aligned) {
        ...
        try {
            ...
            memoryAccessStrategy.putShort(accessAddress, (short) 1);
            assertEquals((short) 1, memoryAccessStrategy.getShort(accessAddress));
    ...
    private void do_test_putGetInt(boolean aligned) {
        ...
        try {
            ...
            memoryAccessStrategy.putInt(accessAddress, 1);
            assertEquals(1, memoryAccessStrategy.getInt(accessAddress));
    ...
    private void do_test_putGetFloat(boolean aligned) {
        ...
        try {
            ...
            memoryAccessStrategy.putFloat(accessAddress, 11.2F);
            assertEquals(11.2F, memoryAccessStrategy.getFloat(accessAddress), 0.0F);
    ...
    private void do_test_putGetLong(boolean aligned) {
        ...
        try {
            ...
            memoryAccessStrategy.putLong(accessAddress, 1L);
            assertEquals(1L, memoryAccessStrategy.getLong(accessAddress));
    ...
    private void do_test_putGetDouble(boolean aligned) {
        ...
        try {
            ...
            memoryAccessStrategy.putDouble(accessAddress, 11.2);
            assertEquals(11.2, memoryAccessStrategy.getDouble(accessAddress), 0.0);
    ...
    private void do_test_compareAndSwapInt(boolean aligned) {
        ...
        try {
            ...
            assertEquals(2, memoryAccessStrategy.getInt(accessAddress));
    ...
    private void do_test_compareAndSwapLong(boolean aligned) {
        ...
        try {
            ...
            assertEquals(2L, memoryAccessStrategy.getLong(accessAddress));
